...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('DEVOLEPER', url='https://t.me/sinu_x_07')
                ]
                ]
            await query.message.edit(text="<b>Developer : <a href='https://t.me/sinu_x_07'>This Person</a>\nLanguage : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://github.com/subinps/Media-Search-bot'>Click here</a>\nUpdate Channel : <a href='https://t.me/updateschnl'>DH FILM CORNER</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('Update Channel', url='https://t.me/HN_MEDIA')
                    ]
                    ]
